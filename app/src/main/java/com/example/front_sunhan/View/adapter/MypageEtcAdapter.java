...
public class MypageEtcAdapter extends RecyclerView.Adapter<MypageEtcAdapter.ViewHolder>{

    private Context context;
    ArrayList<MypageItem> mypageItemArrayList;
    public MypageEtcAdapter(Context context, ArrayList<MypageItem> mypageItemArrayList){
    ...
    @NonNull
    @Override
    public MypageEtcAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View itemView = layoutInflater.inflate(R.layout.mypage_item, parent, false);
        return new MypageEtcAdapter.ViewHolder(itemView /*,this*/);
    }

    @Override
    public void onBindViewHolder(@NonNull MypageEtcAdapter.ViewHolder holder, int position) {
